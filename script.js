...
//  ScrollReveal().reveal('.header-text, .sub-title, .my-skills, .my-education, .portfolio-conainer,.contact-conainer',{ origin: 'top' });

//  ScrollReveal().reveal('.image-box, .skills-container,.edu-div1,.worklist,.contact-list',{ origin: 'bottom' });
//  ScrollReveal().reveal('.header-text h1,.about-col-1 img',{ origin: 'left' });

//  ScrollReveal().reveal('.text-msg, .about-me,.para1,.para2,.read-more-btn,.edu-div2',{ origin: 'right' });